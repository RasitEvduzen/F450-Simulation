function out = quadControlCascade()
%QUADCONTROLCASCADE  Multi-rate cascaded P/PID controller for the quadcopter.
%
%   Common controller interface:
%     out.name                            controller identifier
%     out.mixer(P)                        -> Binv (control allocation)
%     out.initState(P)                    -> controller state (integrators + held outputs)
%     out.step(x, ref, st, P, Binv, run)  -> [delta, st]
%
...
%% ---- shared: control allocation (mixer) ----
